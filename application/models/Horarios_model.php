...
class horarios_model extends CI_Model {
	public function getHorarios(){
		...
		$resultados=$this->db->query("select distinct h.idg, g.grado, g.grupo from horario h, grupo g where g.idg=h.idg and h.idp='$periodo' and h.turno='$turno' order by h.idh");
		$resultados->result();
	...
	public function getinsc($grado, $grupo){
		$periodo= $this->session->userdata("periodo");
		$turno=$this->session->userdata("turno");
