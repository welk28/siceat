    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Horario. </h1> 
            <h3>Docente: <?php echo $this->session->userdata("nombre");?></h3>    
          </div>
          <div class="col-sm-6">
                  ...
                  <?php if(!empty($materias)):?>
                    ...
                    <?php foreach($materias as $ho):?>
                      ...
                      <tr>
                        ...
                        <td align="center">
                            <div class="btn-group">
                              <form action="<?php echo base_url();?>docenteu/materias/lista" method="post">
                                <input type="hidden" value="<?php echo $ho->idh;?>" name="idh">
                                <button type="submit" class="btn btn-sm btn-primary" title="Ver horario" formtarget="_blank">
                                <span class="fas fa-book"></span>
                              </button>
                              </form>
                              <form action="<?php echo base_url();?>docenteu/materias/addcal" method="post">
                                <input type="hidden" value="<?php echo $ho->idh;?>" name="idh">
