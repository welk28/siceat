      ...
      <div class="container-fluid">
        ...
        <div class="card card-default color-palette-box">
          <div class="card-header">
						...
						<form class="BorraHr ml-5" action="<?php echo base_url();?>admin/horario/deleteHr" method="post">
							<input type="hidden" name="base_url" id="base_url" value="<?php echo base_url();?>admin/horario/">
							<input type="hidden" name="idh" id="" value="<?php echo $horario->idh;?>">
							<button type="submit" class="btn btn-sm btn-warning " title="Borrar horario">
