    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-4">
          <a href="<?php echo base_url();?>admin/horarios" class="btn btn-sm btn-success"><i class="fas fa-list"></i> Volver a lista de grupos </a>
          </div>
          <div class="col-sm-6">
                      ...
                      <tr>
                        ...
                        <?php 
                          ...
                          foreach ($horarios as $h ){
                            $agregado= $this->Alumno_model->guardaCursa($h->idh, $a->matricula);
                          }
                          if($agregado==1){?>
                            <td align="center">
