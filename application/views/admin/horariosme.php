                  ...
                  <?php if (!empty($horario)) : ?>
                    ...
                    <?php foreach ($horario as $ho) : ?>
                      ...
                      <tr>
                        ...
                        $ci = &get_instance();
                        $ci->load->model("Horariosme_model");
                        $cant = $ci->Horariosme_model->getinsc($ho->idh);
                        ?>
                        <td align="center">
                          <div class="btn-group">
                            <form class="frmgrupo" action="<?php echo base_url(); ?>admin/alumno/inscribeMe" method="post">
                              ...
                              <button type="submit" class="btn btn-sm btn-primary " title="Inscribir a taller" formtarget="_blank">
