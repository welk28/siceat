  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-4">
            <h1>Lista de calificaciones <?php echo $grado."".$grupo; ?></h1> 
          </div>
              ...
              <table id="x" class="table table-sm table-bordered table-striped bolgral">
                  ...
                  <tr>
                    ...
                    <?php foreach ($horarios as $h ): ?>
                      <th   style="text-align: center;" ><p class="vertical"><?php echo $h->nommat; ?></p></th>
                    <?php endforeach; ?>
                    <th><p class="vertical">TECNOLOGIA</p></th>
                  </tr>
                  ...
                  <?php if(!empty($alumnos)):?>
                    ...
                    <?php foreach ($alumnos as $a ):?>
                      ...
                      <tr>
                        ...
                        <td><?php 
                          $taller= $this->Alumno_model_su->cualTaller($a->matricula);
                        echo $taller->nomt;?> </td>  
                        <td><?php echo $a->app." ".$a->apm." ".$a->nom;?> </td>                        
                          ...
                          <?php foreach ($horarios as $h ): ?>
                            ...
                            <td align="center">
                              <?php
                                $calif= $this->Alumno_model_su->verCal($h->idh, $a->matricula);
                                //echo $a->matricula."/ ".$h->idh."/".$calif->tr1;
                                if($calif->tr1==0){echo "";}else{
                                echo $calif->tr1;} ?>
                            </td>
                          <?php endforeach;?>
                        <td align="center"><?php 
                          //$hora= $this->Alumno_model->verHorario($a->grado, $a->idt);
                          $cal= $this->Alumno_model_su->verCalt($a->matricula);
                          //echo $a->grado."/".$a->idt."/".$cal->tr1; 
                         if(empty($cal->tr1)){echo "Nc";}else{echo $cal->tr1; } ?></td>
                      </tr>
                    <?php endforeach;?>
                  <?php endif;?>  
