      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <h3><?php if($turno=='V'){ echo "Vespertino" ;}else{echo "Matutino";} ?></h3>
          </div>
          <div class="col-sm-3">
          <a href="<?php echo base_url();?>su/horariost" class="btn btn-sm btn-success"><i class="fas fa-list"></i> Volver a lista de Talleres </a>
          </div>
          <div class="col-sm-3">
                  ...
                  <?php if(!empty($alumnos)):?>
                    ...
                    <?php foreach ($alumnos as $a ):?>
                      ...
                      <tr>
                        ...
                        <?php             
                          $agregado= $this->Alumno_model_su->guardaCursa($idh, $a->matricula);
                          if($agregado==1){?>
                            <td align="center">
