                  ...
                  <?php if(!empty($horario)):?>
                    ...
                    <?php foreach($horario as $ho):?>
                      ...
                      <tr>
                        ...
                        <td><?php if($ho->turno=='V'){ echo "Vesp" ;}else{echo "Mat";}?> </td>
                        ...
                        <td align="center">
                          ...
                          <?php else: ?>
                            <div class="btn-group">
                            <form class="frmgrupo" action="<?php echo base_url();?>su/alumno/inscribeGrupo" method="post">
                              <input type="text" name="grado" value="<?php echo $ho->grado; ?>" id="">
                              <input type="text" name="grupo" value="<?php echo $ho->grupo; ?>" id="">
                              <input type="text" name="turno" value="<?php echo $ho->turno; ?>" id="">
