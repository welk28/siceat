                    ...
                    <?php foreach($horario as $ho):?>
                      ...
                      <tr>
                        ...
                        <?php //invocamos la instancia y el modelo
                          $ci = &get_instance();
                          $ci->load->model("su/Horariost_model_su");
                           
                          $cant= $ci->Horariost_model_su->getinsc($ho->idh);
                           ?>
                        ...
                        <td align="center">
                          ...
                          <?php else: ?>
                            <div class="btn-group">
                            <form class="frmgrupo" action="<?php echo base_url();?>su/alumno/inscribeTaller" method="post">
