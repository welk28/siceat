  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Calificaciones por grupo </h1> 
                  ...
                  <?php if(!empty($horario)):?>
                    ...
                    <?php foreach($horario as $ho):?>
                      ...
                      <tr>
                        ...
                        <td><?php if($ho->turno=='V'){ echo "Vespertino" ;}else{echo "Matutino";}?> </td>
                        <?php //invocamos la instancia y el modelo
                          $ci = &get_instance();
                          $ci->load->model("su/Horarios_model_su");
                           
                          $cant= $ci->Horarios_model_su->getinsc($ho->grado, $ho->grupo, $ho->turno);
                           ?>
                        ...
                        <td align="center">
                            ...
                            <div class="btn-group">
                            <form class="frmgrupo" target="_blank" action="<?php echo base_url();?>su/reporte/bgpolist" method="post">
                              <input type="hidden" name="grado" value="<?php echo $ho->grado; ?>" id="">
                              <input type="hidden" name="grupo" value="<?php echo $ho->grupo; ?>" id="">
                              <input type="hidden" name="turno" value="<?php echo $ho->turno; ?>" id="">
                              <button type="submit" class="btn btn-sm btn-success" title="Ver calificaciones grupal">
